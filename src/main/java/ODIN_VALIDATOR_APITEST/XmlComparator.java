		...
		// List differences_request_procesor = compareXML(ActualResults.obtainResponse_request_processor(path, actualXml), strExpected); 
		 ...
		 case 2:
			 ...
			 if(version == 1) {
		    	 ...
		    	 List differences_request_procesor = compareXML(ActualResults.obtainResponse_request_processor(path, actualXml,VERSION_PROCESSOR_12), strExpected); 
	             // System.out.println("differences_validator");
	              printDifferences(differences_request_procesor);
	              break;
		    }else if (version == 13){
		    	 List differences_request_procesor = compareXML(ActualResults.obtainResponse_request_processor(path, actualXml,VERSION_PROCESSOR_13), strExpected); 
	             // System.out.println("differences_validator");
	              printDifferences(differences_request_procesor);
	              break;
		    }else if(version ==14) {
		    	...
		    	List differences_request_procesor = compareXML(ActualResults.obtainResponse_request_processor(path, actualXml,VERSION_PROCESSOR_19), strExpected); 
	             // System.out.println("differences_validator");
	              printDifferences(differences_request_procesor);
	              break;
		    } else if (version ==20) {
		    	List differences_request_procesor = compareXML(ActualResults.obtainResponse_request_processor(path, actualXml,VERSION_PROCESSOR_20), strExpected); 
	             // System.out.println("differences_validator");
	              printDifferences(differences_request_procesor);
	              break;
		    } else if (version ==21) {
		    	List differences_request_procesor = compareXML(ActualResults.obtainResponse_request_processor(path, actualXml,VERSION_PROCESSOR_21), strExpected); 
	             // System.out.println("differences_validator");
	              printDifferences(differences_request_procesor);
	              break;
		    }
