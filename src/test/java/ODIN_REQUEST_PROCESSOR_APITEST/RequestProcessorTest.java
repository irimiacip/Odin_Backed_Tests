...
static boolean value = true;
	...
	public void test3() throws Exception {	
		...
		executeQuerryDB(CLEAN_DB, strUserID, strPassword, dbURL);	
		XmlComparator.read_xml_expected(2, 12,FILEPATH_REQUEST_PROCESSOR, "test_1.xml" , PATH_EXPECTED_REQUEST_PROCESSOR, "expected_2.xml","null",0);
		listactual = getDatafromDB(executeQuerryDB(GET_DATA_DB,strUserID, strPassword, dbURL));
	...
	public void test4() throws Exception {	
		...
		executeQuerryDB(CLEAN_DB, strUserID, strPassword, dbURL);	
		XmlComparator.read_xml_expected(2, 13,FILEPATH_REQUEST_PROCESSOR, "test_1.xml" , PATH_EXPECTED_REQUEST_PROCESSOR, "expected_3.xml","null",0);
		listactual = getDatafromDB(executeQuerryDB(GET_DATA_DB,strUserID, strPassword, dbURL));
	...
	public void test18() throws Exception {	
		...
		executeQuerryDB(CLEAN_DB, strUserID, strPassword, dbURL);
		XmlComparator.read_xml_expected(2, 8,FILEPATH_REQUEST_PROCESSOR, "test_15.xml" , PATH_EXPECTED_REQUEST_PROCESSOR, "expected_17.xml","null",0);
		listactual = getDatafromDB(executeQuerryDB(GET_DATA_DB,strUserID, strPassword, dbURL));
